...
import type { ExternalBlob as _ExternalBlob, FashionDesignSubmission as _FashionDesignSubmission, SubmissionStatus as _SubmissionStatus, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async adminGetAllSubmissions(): Promise<Array<FashionDesignSubmission>> {
        if (this.processError) {
            try {
    ...
    async getAllSubmissions(): Promise<Array<FashionDesignSubmission>> {
        if (this.processError) {
            try {
    ...
    async getSubmissionsByStatus(arg0: SubmissionStatus): Promise<Array<FashionDesignSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSubmissionsByStatus(to_candid_SubmissionStatus_n18(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUnpaidSelectedDesigns(): Promise<Array<FashionDesignSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUnpaidSelectedDesigns();
                return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markDesignAsPaid(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markDesignAsPaid(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDesign(arg0: FashionDesignSubmission): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDesign(await to_candid_FashionDesignSubmission_n20(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSubmissionStatus(arg0: string, arg1: SubmissionStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSubmissionStatus(arg0, to_candid_SubmissionStatus_n18(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_FashionDesignSubmission_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FashionDesignSubmission): Promise<FashionDesignSubmission> {
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? SubmissionStatus.pending : "rejected" in value ? SubmissionStatus.rejected : "selected" in value ? SubmissionStatus.selected : value;
}
...
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FashionDesignSubmission>): Promise<Array<FashionDesignSubmission>> {
    return await Promise.all(value.map(async (x)=>await from_candid_FashionDesignSubmission_n9(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_FashionDesignSubmission_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: FashionDesignSubmission): Promise<_FashionDesignSubmission> {
    return await to_candid_record_n21(_uploadFile, _downloadFile, value);
}
function to_candid_SubmissionStatus_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubmissionStatus): _SubmissionStatus {
...
async function to_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        status: to_candid_SubmissionStatus_n18(_uploadFile, _downloadFile, value.status),
        title: value.title,
        description: value.description,
        isPaid: value.isPaid,
        email: value.email,
        timestamp: value.timestamp,
        image: await to_candid_ExternalBlob_n22(_uploadFile, _downloadFile, value.image),
        artistName: value.artistName
    };
}
...
function to_candid_variant_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SubmissionStatus): {
    pending: null;
} | {
    rejected: null;
} | {
    ...
    return value == SubmissionStatus.pending ? {
        ...
        rejected: null
    } : value == SubmissionStatus.selected ? {
        selected: null
    } : value;
}
